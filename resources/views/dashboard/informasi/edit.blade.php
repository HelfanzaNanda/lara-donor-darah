...
<div class="row">
    <div class="box box-primary">
        <div class="box-header with-border" style="margin-left:0px;">
            ...
            <span class="fa fa-arrow-left"></span></a> Edit Informasi</h4>
        </div>
        @if ($errors->any())
        ...
        @endif
        <form method="post" action="{{route('informasi.update',$info->id)}}"  enctype="multipart/form-data">
        {{csrf_field()}}
        {{method_field('put')}}
            <div class="box-body">
                <div class="form-group">
                    <label>Judul</label>
                    <input type="text" class="form-control" name="title" placeholder="Masukkan Title" value="{{$info->title}}">
                </div>
                <div class="form-group">
                    <div id="image-preview" style="width:200px;background-image:url(/uploads/{{$info->image}});">
                ...
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-control" required>
                        ...
                        <option value="informasi" {{$info->kategori == 'informasi' ? 'selected':''}}>Informasi</option>
                ...
                <div class="form-group">
                    <label>Konten</label>
                    <textarea id="editor1" name="content" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$info->content}}</textarea>
                </div>
            </div>

    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border" style="margin-left:0px;">
                ...
                <span class="fa fa-arrow-left"></span></a> Edit Pendonor</h4>
            </div>
            @if ($errors->any())
            ...
            @endif
            <form method="post" action="{{route('pendonor.update', $pendonor->id)}}" enctype="multipart/form-data" autocomplete="off">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
                <div class="box-body">
                    <div class="form-group">
                        <label>No KTP</label>
                        <input type="text" class="form-control" name="ktp" placeholder="Mulyono" value="{{$pendonor->ktp}}">
                    </div>
                    <div class="form-group">
                        <label>Nama Pendonor</label>
                        <input type="text" class="form-control" name="nama" placeholder="Mulyono" value="{{$pendonor->nama}}">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tempat Lahir</label>
                                <input type="text" class="form-control" name="tempat_lahir" placeholder="Tegal" value="{{$pendonor->tempat_lahir}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tanggal Lahir</label>
                                <input type="text" class="form-control datepicker" name="tanggal_lahir" placeholder="dd-mm-yy" value="{{$pendonor->tanggal_lahir}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>
                                    <input type="radio" name="jenis_kelamin" class="flat-red" value="laki-laki" {{ $pendonor->jenis_kelamin == 'laki-laki' ? 'checked' : ''}}> Laki-Laki
                                </label>
                                <label>
                                    <input type="radio" name="jenis_kelamin" class="flat-red" value="perempuan" {{ $pendonor->jenis_kelamin == 'perempuan' ? 'checked' : ''}}> Perempuan
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" class="form-control" rows="3" placeholder="Jl Mangga Mengkel, No 03">{{$pendonor->alamat}}</textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_ibu" placeholder="Siti Barokah" value="{{$pendonor->nama_ibu}}">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>
                                    <input type="radio" name="status_nikah" class="felat-red" value="Menikah" {{$pendonor->status_nikah == "Menikah" ? 'checked' : ''}}> Menikah
                                </label>
                                <label>
                                    <input type="radio" name="status_nikah" class="felat-red" value="Belum Menikah" {{$pendonor->status_nikah == "Belum Menikah" ? 'checked' : ''}}> Belum Menikah
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Telepon</label>
                        <input type="text" class="form-control" name="phone" placeholder="082328321344" value="{{$pendonor->phone}}">
                    </div>

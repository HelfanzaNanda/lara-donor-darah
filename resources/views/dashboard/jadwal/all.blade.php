...
<div class="row">
  <div class="box">
          <div class="box-header">
              <a href="{{route('jadwal.create')}}" class="btn btn-secondary bg-green btn-sm pull-left" style="margin-top: 0px; margin-bottom: 0px;"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Jadwal</a>
          </div>
      </div>
      <div class="box">
          <!-- Horizontal Form -->
  ...
  <script>
    $(function() {
      $('#jadwal-table').DataTable({
        ...
        { data: 'nama', name: 'nama' },
        { data: 'hari_tanggal', name: 'hari_tanggal' },

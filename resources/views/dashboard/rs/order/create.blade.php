...
<div class="row">
    <div class="box">
        <div class="box-header" style="margin-top:0px;margin-bottom:0px;">
            <h4><a href="#" class="text-black"><span class="fa fa-arrow-left"> </span>  </h4>
        </div>
        @if ($errors->any())
        ...
        <div class="box-body" style="margin-top:0px;">
            <form action="{{route('order.storecheckout')}}" method="post">
                @csrf
                <input type="text" name='darah_id' placeholder="id darah">
                ...
                <div class="row" style="margin-top:0px;">
                    <div class="col-md-2">
                        <div class="form-group" style="margin-top:0px;">
                            ...
                            <input type="text" class="form-control" name="gol_dar" placeholder="Golongan Darah" value="A" readonly>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group" style="margin-top:0px;">
                            <label>Rhesus</label>
                            <input type="text" class="form-control" name="rhesus" placeholder="Golongan Darah" value="+" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group" style="margin-top:0px;">
                            <label>Jenis Darah</label>
                            <input type="text" class="form-control" name="jenis_darah" placeholder="Jenis Darah" value="TCsad" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group" style="margin-top:0px;">
                            <label>Stok Darah</label>
                            <input type="text" class="form-control" name="qty" placeholder="Stok Darah">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group" style="margin-top:0px;">
                            <label>Harga</label>
                            <input type="text" class="form-control" name="harga" placeholder="Harga Darah" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group" style="margin-top:0px;">
